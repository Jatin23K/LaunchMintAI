...
│       │   ├── llm_engine.py                 # Gemini 2.0 Flash + multi-key rotation
...
│       │
│       ├── extensions/                       # Plugin Architecture (20+ modules)
...
│           ├── classifier.py                 # XGBoost survival classifier
...
│           ├── evaluate.py                   # Model evaluation (AUC, F1, confusion matrix)
│           ├── METHODOLOGY.md                # Full DS methodology documentation
│           ├── models/
...
│               ├── dataset.jsonl             # 50 labeled startup ideas (11 domains)
│               ├── golden.test.py            # Correctness test → 50/50, 100%
│               ├── benchmark.py              # Performance metrics → 386ms avg
...
│   ├── index.html
│   ├── index.tsx
│   ├── App.tsx                               # Root: tab navigation + state
...
| P95 Latency | 596ms |
| Dataset Size | 50 ideas × 11 domains |
